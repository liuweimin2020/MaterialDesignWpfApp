...
namespace MaterialDesignTemplate
{
    public class MainWindowViewModel
    {
        public MainWindowViewModel(ISnackbarMessageQueue snackbarMessageQueue)
        {
            ...
            ViewItems = new[]
            {
                new ViewItem("主页", new LoginWindow(),
                    new []
                    {
                        new DocumentationLink(DocumentationLinkType.Wiki, $"{ConfigurationManager.AppSettings["GitHub"]}/wiki", "WIKI"),
                        DocumentationLink.DemoPageLink<LoginWindow>("User Login"),
                        DocumentationLink.DemoPageLink<LoginWindowViewModel>("Login View Model")
                    }
                ),
                //new ViewItem("调色板",  new PaletteSelector2 { DataContext = new PaletteSelectorViewModel() },
                //    new []
                //    {
                ...
                //        DocumentationLink.DemoPageLink<PaletteSelector2>("Demo View"),
